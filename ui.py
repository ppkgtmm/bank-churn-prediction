...
with col1:
    ...
    total_trans_amt = st.number_input('Total Transaction Amount', min_value=0)
...
with col2:
    ...
    total_amt_chng_q4_q1 = st.number_input('Change Amount Q4/Q1', min_value=0)
...
with col3:
    ...
    total_ct_chng_q4_q1 = st.number_input('Change Count Q4/Q1', min_value=0)
